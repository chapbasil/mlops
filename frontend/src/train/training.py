...
def start_training(config: dict, endpoint: object) -> None:
   ...
   # fig_imp = plot_param_importances(study) закомментировано, т.к. в докер ошибка, без докера работает
    fig_history = plot_optimization_history(study)
  #  st.plotly_chart(fig_imp, use_container_width=True) закомментировано, т.к. в докер ошибка, без докера работает
